...
def generate_data_description(save_dir, reorder):
    ...
    with open(os.path.join(save_dir, 'dataset1.pkl'), 'wb+') as f:
        pickle.dump(dataset, f)


if __name__ == "__main__":
    save_dir = '/home/sohaibrabbani/PycharmProjects/Strong_Baseline_of_Pedestrian_Attribute_Recognition/data/RAP2/'
    reorder = True
